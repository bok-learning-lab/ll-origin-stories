...
Thirty current eight-panel comics explore four origin frames and a villain inversion. The immigrant, exposure, and mutant editions each contain four individual origins and a team story. A Golden Age printed edition re-renders the five immigrant stories with unchanged text. The modern resources edition includes four affluent antihero stories and The Discretionary Avengers; the 1980s corporate-gothic villain edition includes four individual origins and The Institute for Your Own Good. Earlier short mutant versions remain available. Marlon, Jordan, Madeleine and Jonah are some of the people who led some of the many origin-story AI-generation workshops this week; this is not a complete roster of the Learning Lab. The [presentation](site/index.html) contains selected stories and character sheets, with an individual card and reader for each comic. Wealth, villain behavior, businesses and supernatural powers are fictional.
